 ...
 * 
 * @author huanglicong
 * @since 1.0 2013年11月24日 上午11:19:36
 */
public class FloatTypeHandler extends BaseTypeHandler<Float> {
	...
	@Override
	public void setNonNullParameter(PreparedStatement statement, int index, Float parameter, int jdbcType) throws SQLException {
