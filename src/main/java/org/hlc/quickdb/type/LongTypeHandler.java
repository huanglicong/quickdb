 ...
 * 
 * @author huanglicong
 * @since 1.0 2013年11月24日 上午11:30:21
 */
public class LongTypeHandler extends BaseTypeHandler<Long> {
	...
	@Override
	public void setNonNullParameter(PreparedStatement statement, int index, Long parameter, int jdbcType) throws SQLException {
	...
	public Long getNullableResult(CallableStatement callableStatement, int columnIndex) throws SQLException {
		...
		return callableStatement.getLong(columnIndex);
	}
