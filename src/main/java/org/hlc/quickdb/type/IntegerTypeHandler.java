 ...
 * 
 * @author huanglicong
 * @since 1.0 2013年11月24日 上午11:27:32
 */
public class IntegerTypeHandler extends BaseTypeHandler<Integer> {

	public IntegerTypeHandler(int jdbcType) {
		super(jdbcType);
	}
	...
	@Override
	public void setNonNullParameter(PreparedStatement statement, int index, Integer parameter, int jdbcType) throws SQLException {
